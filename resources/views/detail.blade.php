          ...
          <div class="col-md-8 col-sm-12">
              ...
              <div class="card">
                  <div class="card-header d-flex align-items-center justify-content-between">
                      <h4>Stay & Learn Salsa <span>Featured</span></h4>
                      <div class="rating">
                  ...
                  <div class="card-body">
                      <div class="row">
                          ...
                          <div class="col-md-6 text-center">
                              <img class="w-100" src="assets/img/slide/slide-17.jpg" alt="video">
                              <p>Watch Video</p>
                          </div>
                      </div>
              ...
              <div class="card">
                  <div class="card-header d-flex align-items-center justify-content-between">
                      <h4>What you'll have as:</h4>
                  </div>
                  <div class="card-body">
                      <ul>
                          <li><i class="fa fa-circle"></i> Breakfast [xx, xxx] </li>
                          <li><i class="fa fa-circle"></i> Lunch [xx, xxx]  </li>
                          <li><i class="fa fa-circle"></i> Dinner [xx, xxx] </li>
                      </ul>
                      ...
                      <div class="row">
                          ...
                          <div class="col-md-6 col-sm-12">
                              <p>
                                  ...
                                  Cleaning available during stay</p>
                          </div>
                          <div class="col-md-6 col-sm-12">
                              <p>
                                  <svg width="19" height="21" viewBox="0 0 19 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                  <path d="M15.5 17   .5C16.241 17.5 16.9587 17.7633 17.5033 18.2568C17.7327 18.4638 18.0357 18.5905 18.3597 18.619L18.5 18.625V20.125L18.329 20.1205C17.6502 20.0868 17.0034 19.8213 16.4967 19.3683C16.2214 19.1266 15.8663 18.9955 15.5 19C15.1235 19 14.7665 19.1313 14.504 19.3683C13.9531 19.8596 13.2396 20.1292 12.5015 20.125C11.7628 20.1296 11.0488 19.8599 10.4975 19.3683C10.2219 19.1265 9.86658 18.9953 9.5 19C9.12275 19 8.765 19.1313 8.50325 19.3683C7.95235 19.8595 7.23888 20.1292 6.50075 20.125C5.7622 20.1297 5.04815 19.8604 4.49675 19.369C4.22148 19.1271 3.86642 18.9957 3.5 19C3.12275 19 2.765 19.1313 2.5025 19.3683C1.99601 19.8211 1.34957 20.0866 0.671 20.1205L0.5 20.125V18.625L0.64025 18.619C0.957519 18.5945 1.25818 18.4673 1.49675 18.2568C2.04773 17.7651 2.76157 17.4954 3.5 17.5C4.241 17.5 4.95875 17.764 5.50325 18.2568C5.76575 18.4938 6.12275 18.6243 6.50075 18.625C6.87725 18.625 7.235 18.4938 7.49675 18.256C8.04781 17.7646 8.76166 17.4952 9.5 17.5C10.241 17.5 10.9587 17.7633 11.5033 18.2568C11.7657 18.4938 12.1227 18.6243 12.5007 18.625C12.8772 18.625 13.235 18.4938 13.4967 18.2568C14.0475 17.7653 14.7618 17.4956 15.5 17.5ZM15.5 13.75C16.241 13.75 16.9587 14.0133
C2.04773 10.2651 2.76157 9.99545 3.5 10C4.241 10 4.95875 10.264 5.50325 10.7568C5.76575 10.9938 6.12275 11.1243 6.50075 11.125C6.87725 11.125 7.235 10.9938 7.49675 10.756C8.00361 10.3029 8.6507 10.0376 9.32975 10.0045L9.5 10V6.25H0.5V4.75H9.5V3.25C9.50174 2.86077 9.35211 2.48609 9.08272 2.20514C8.81332 1.92418 8.44526 1.75895 8.0563 1.74435C7.66733 1.72974 7.28792 1.86691 6.99821 2.12687C6.70851 2.38683 6.5312 2.74923 6.50375 3.1375L6.5 3.25H5C5.00011 2.64069 5.18576 2.04585 5.53225 1.54464C5.87873 1.04342 6.36962 0.659596 6.9396 0.444224C7.50959 0.228852 8.13164 0.192146 8.723 0.33899C9.31435 0.485835 9.84698 0.809267 10.25 1.26625C10.531 0.946365 10.8771 0.690211 11.2652 0.514946C11.6532 0.339681 12.0742 0.24935 12.5 0.250004ZM11 10.3923C11.12 10.4605 11.2347 10.5378 11.3442 10.6225L11.5033 10.7568C11.7657 10.9938 12.1227 11.1243 12.5007 11.125C12.83 11.125 13.1458 11.0245 13.394 10.84L13.4967 10.7568C13.6512 10.6165 13.82 10.4943 13.9993 10.3923V6.25H10.9993L11 10.3923ZM12.5 1.75C12.1216 1.74988 11.7571 1.89281 11.4796 2.15013C11.2021 2.40744 11.0321 2.76014 11.0037 3.1375L11 3.25V4.75H14V3.25C14 2.85218 13.842 2.47065 13.5607 2.18934C13.2794 1.90804 12.8978 1.75 12.5 1.75Z" fill="#222222"/>
                                  </svg>
                                  Pool - infinity, saltwater</p>
                          </div>
                          <div class="col-md-6 col-sm-12">
                              <p>
              ...
              <div class="card">
                  <div class="card-header d-flex">
                      <div class="form-check">
                        <input type="radio" name="bookingtype" id="bookingtype_chose_dates" value="Choose Dates" checked>
                        <label for="bookingtype_chose_dates">
                          Choose Dates
                        </label>
                      </div>
                      <div class="form-check">
                        <input type="radio" name="bookingtype" id="bookingtype_daypass" value="Day Pass">
                        <label for="bookingtype_daypass">
                          Day Pass <span>Day Pass Does not include overnight stay. It's usually between 10 am and 4pm</span>
                        </label>
                      </div>
                  </div>
                  <div class="card-body">
                      <div id="choose_dates_div" class="">
                          <p>Select your dates of visit</p>
                      </div>
                      <div id="day_pass_div" class="" style="display: flex">
                          
                          <div id="choose_dates_calendar_1" class="calendar card">
                                  
                          </div>
                          
                          <div id="choose_dates_calendar_2" class="calendar card">
                                  
                          </div>
                          
                      </div>
                      
                      <h4 class="mt-5">Maximum Guest per room [2]</h4>
