        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>English</span> <i class="bi bi-chevron-down"></i></a>
            ...
            <li>
                    ...
                    <button style="border-radius: 10%; background: green; border: 1px solid; color: #fff; margin-left:10px; padding: 10px 20px; font-size: 16px;
    font-weight: 500;">Login/Signup</button>
